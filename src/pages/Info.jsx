  ...
  return (
    <div className="bg-white">
      ...
      */}
      ...
      {/* ── Capability Pillars ── */}
      <section className="relative overflow-hidden bg-[#FAF6EF] px-6 md:px-16 py-20 md:py-28">
        ...
        <h2 className="font-serif text-[#0B2A4A] text-3xl md:text-5xl font-bold leading-[1.1] mb-4 max-w-2xl">
          Commerce, Distribution, Innovation and Data
        </h2>
        <p className="text-[#4A5568] text-base font-light leading-[1.9] max-w-2xl mb-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-px bg-[#EAE6DF] rounded-lg overflow-hidden border border-[#EAE6DF]">
          {pillars.map((item) => (
            ...
            >
              <span className="block text-[#0B2A4A]/25 text-xs font-semibold tracking-[2px] mb-5 transition-colors duration-300 group-hover:text-[#C9963A]/70">
                {item.num}
              </span>
              <h3 className="font-serif text-[#0B2A4A] text-xl font-bold mb-3 transition-colors duration-300 group-hover:text-[#C9963A]">
                {item.title}
              </h3>
              <p className="text-[#4A5568] text-sm leading-relaxed transition-colors duration-300 group-hover:text-white/60">
                {item.text}
      ...
      <section className="bg-[#0B2A4A] px-6 md:px-16 py-20 md:py-28">
        ...
        <h2 className="font-serif text-white text-3xl md:text-4xl font-bold leading-[1.15] mb-4">
          Commercial Launch Now. Owned Manufacturing Next.
        </h2>
        <p className="text-white/60 text-base leading-[1.9] max-w-2xl mb-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {timeline.map((item, i) => (
            <div
              key={item.period}
              className="group relative bg-white/5 border border-white/10 rounded-lg p-7 transition-all duration-300 hover:border-[#C9963A]/50 hover:bg-white/[0.07]"
            >
              <div className="text-[#C9963A] font-serif text-lg font-bold mb-3 tracking-wide">
                {item.period}
              </div>
